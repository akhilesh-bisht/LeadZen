      ...
      <div className="relative bg-white rounded-3xl max-w-md w-full p-6 sm:p-7 shadow-2xl border border-slate-200/90 z-10 space-y-5 animate-in fade-in zoom-in-95 duration-150 max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-extrabold text-slate-900 tracking-tight">
                {mode === 'login' ? 'Account Authentication' : 'Create New User'}
              </h3>
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 gap-2">
            ...
            <button
              type="button"
              onClick={() => handleQuickLogin('akhilesh@gmail.com', 'akhilesh')}
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-amber-800/80 font-mono">akhilesh@gmail.com (pass: akhilesh)</div>
                </div>
              </div>
            ...
            <button
              type="button"
              onClick={() => handleQuickLogin('dhananjay@company.sales', 'password123')}
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-emerald-800/80 font-mono">dhananjay@company.sales</div>
                </div>
              </div>
            ...
            <button
              type="button"
              onClick={() => handleQuickLogin('harsh@company.sales', 'password123')}
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-indigo-800/80 font-mono">harsh@company.sales</div>
                </div>
              </div>
