...
import { X, Save, Loader2, Phone, Mail, Globe, MapPin, Building2, Tag, FileText } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-zinc-950/60 backdrop-blur-xs">
      <div className="bg-white rounded-2xl max-w-2xl w-full border border-zinc-200 shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-150 max-h-[90vh] flex flex-col">
        ...
        <div className="px-6 py-4 border-b border-zinc-200 flex items-center justify-between bg-zinc-50/80">
          <div>
            <h3 className="text-base font-extrabold text-zinc-900">Edit Lead Record</h3>
            <p className="text-xs text-zinc-500">Changes will be saved directly to the database.</p>
          </div>
          <button
            onClick={onClose}
